...
function App() {
  ...
  useEffect(() => {
    trackPageVisit('Page Loaded')
    
    // Preload actual hero background image
    const img = new Image()
    img.src = '/hero-goa-seniors.png'
      ...
      <div className={`screen day-screen ${currentScreen === 1 ? 'active' : ''}`}>
        ...
        <div className="day-content anim-child">
          ...
          <button className="btn-next" onClick={() => goToScreen(2)}>
            Beach Visits <span className="next-day-text">(Next Day)</span> &nbsp;→
          </button>
        </div>
      </div>
        ...
        <div className="day-content anim-child">
          ...
          <div className="acts">
            <div className="act">
              ...
              <span className="act-text">Aguada Fort</span>
            </div>
            <div className="act">
              <span className="act-num"><Sunset size={18} strokeWidth={1.5} /></span>
              <span className="act-text">Baga & Anjuna Beach</span>
            </div>
            <div className="act">
          ...
          <button className="btn-next" onClick={() => goToScreen(3)}>
            Cruise Party <span className="next-day-text">(Next Day)</span> &nbsp;→
          </button>
        </div>
      </div>
